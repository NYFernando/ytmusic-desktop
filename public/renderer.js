...
function updateUI(state) {
  ...
  // Windows SMTC & MediaSession Integration for Taskbar Media Widgets, Windhawk Mods, & System Flyouts
...
function updateSystemMediaSession(state) {
  ...
  try {
    ...
    console.warn('[MediaSession] Failed to update SMTC:', err);
  }
}
...
if ('mediaSession' in navigator) {
  try {
    navigator.mediaSession.setActionHandler('play', () => {
      ...
      if (isOfflineMode) offlineAudioPlayer.play();
    });
    ...
    navigator.mediaSession.setActionHandler('previoustrack', () => {
      ...
      if (isOfflineMode) playPreviousOfflineTrack();
    });
